...
const API_URL = 'https://bcac-2620-101-f000-7c0-00-10eb.ngrok-free.app/api/register/';  // backend registration URL
const API_BASE_URL = "https://bcac-2620-101-f000-7c0-00-10eb.ngrok-free.app/api"; // Change if using a different URL
