...
const API_URL = 'https://8607-129-97-124-149.ngrok-free.app/api/register/';  // backend registration URL
const API_BASE_URL = "https://8607-129-97-124-149.ngrok-free.app/api"; // Change if using a different URL
