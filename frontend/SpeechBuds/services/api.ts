...
const API_URL = 'https://cdaa-24-114-29-182.ngrok-free.app/api/register/';  // backend registration URL
const API_BASE_URL = "https://cdaa-24-114-29-182.ngrok-free.app/api"; // Change if using a different URL
