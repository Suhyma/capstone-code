...
const API_URL = 'https://9237-192-159-178-221.ngrok-free.app/api/register/';  // backend registration URL
const API_BASE_URL = "https://9237-192-159-178-221.ngrok-free.app/api"; // Change if using a different URL
