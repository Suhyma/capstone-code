...
const API_URL = 'https://2b6a-24-114-29-182.ngrok-free.app/api/register/';  // backend registration URL
const API_BASE_URL = "https://2b6a-24-114-29-182.ngrok-free.app/api"; // Change if using a different URL
