...
const API_URL = 'https://61ea-192-159-178-211.ngrok-free.app/api/register/';  // backend registration URL
const API_BASE_URL = "https://61ea-192-159-178-211.ngrok-free.app/api"; // Change if using a different URL
